...
function Quiz({ userId, direction, onDirectionChange, settingsError, onSaved }) {
  const { speak, stop, supported: audioSupported, audioError } = useGermanSpeech();
